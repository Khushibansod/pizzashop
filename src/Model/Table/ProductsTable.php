...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('medium');

        $validator
            ->integer('large')
            ->requirePresence('large', 'create')
            ->notEmptyString('large');

        $validator
            ->integer('glutenfree')
            ->requirePresence('glutenfree', 'create')
            ->notEmptyString('glutenfree');

        $validator
            ->integer('thincrust')
            ->requirePresence('thincrust', 'create')
            ->notEmptyString('thincrust');

        $validator
            ->integer('stuffedcrust')
            ->requirePresence('stuffedcrust', 'create')
            ->notEmptyString('stuffedcrust');
